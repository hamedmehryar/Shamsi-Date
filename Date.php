...
*    This is the same value returned from php.time() for the equivalent Julian 
*    date. (php.date() returns equival Julian date for this time stamp.)
*
* Function call:
...
*   to create timestamp for a given date.
* format(format, [time stamp], [decorate]) 
*   to build readable output from time stamp.
*/
namespace Shamsi;
class Date
{
